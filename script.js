...
function modifiedString(date){
    return 'Note Last Modified: ' + date.getDate() + '/' + (date.getMonth() + 1) + '/' +  date.getFullYear()+ ' ' + date.getHours() + ':' + date.getMinutes() + ':' + date.getSeconds();
}
...
function newNote(){
    ...
    note.left = Math.round(Math.random() * 200) + 'px';
